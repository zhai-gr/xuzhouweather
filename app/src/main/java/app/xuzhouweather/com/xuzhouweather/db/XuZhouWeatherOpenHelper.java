 ...
 */
public class XuZhouWeatherOpenHelper extends SQLiteOpenHelper {
    //Province表建表语句
    ...
    public XuZhouWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
